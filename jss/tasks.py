...
def update_computer(jss_id, name):
    ...
    jss_computer_id = jss_computer_general.pop('id')#!/usr/bin/env python
...
#     else:
    jss_site = True
    computer, _ = Computer.objects.get_or_create(computer_id=jss_computer_id, real_name=jss_site)
